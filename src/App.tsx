          ...
          <div id="profile-pane" className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 animate-fade-in w-full">
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="bg-white border border-amber-100 rounded-3xl p-5 sm:p-7 md:p-8 shadow-sm">
                ...
                {/* Mobile APK App Icon & Branding Panel */}
                <div id="mobile-app-icon-panel" className="mt-8 border-t border-amber-100 pt-6">
                  <h3 className="text-xs font-bold text-amber-900 uppercase tracking-widest mb-3 flex items-center gap-1.5">
                    <Smartphone className="w-4 h-4 text-rose-500" />
                    <span>Mobile APK App Launcher Icon</span>
                    <span className="px-2 py-0.5 rounded-full bg-rose-100 text-rose-800 text-[10px] font-semibold lowercase">
                      installed on mobile
                    </span>
                  </h3>
                  ...
                  <div className="p-5 rounded-2xl border border-rose-200/80 bg-gradient-to-br from-rose-50/40 via-white to-amber-50/40 space-y-4">
                    <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-5">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div className="space-y-1">
                          ...
                          <p className="text-[11px] text-amber-800 leading-relaxed max-w-sm">
                            Crafted with the glowing 3D sculpted pink heart inspired by the Next Chapter homepage emblem. Harmonized with a warm rose-cream ceramic palette.
                          </p>
                      ...
                      <div className="flex flex-row md:flex-col gap-2 shrink-0 w-full md:w-auto">
                        <a
                          href="/app-icon.png"
                          download="next-chapter-app-icon.png"
                          className="px-3 py-2 rounded-xl bg-rose-500 hover:bg-rose-600 text-white font-bold text-xs shadow-xs transition-all flex items-center justify-center gap-1.5 cursor-pointer flex-1 md:flex-initial"
                        >
                        ...
                        <a
                          ...
                          className="px-3 py-2 rounded-xl bg-white border border-amber-200 hover:bg-amber-50 text-amber-900 font-bold text-xs shadow-xs transition-all flex items-center justify-center gap-1.5 cursor-pointer flex-1 md:flex-initial"
                        >
